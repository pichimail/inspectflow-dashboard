import { LayoutDashboard, Inbox, ClipboardCheck, Users, FileText, Building2, FolderOpen, Mail, GitBranch, Star, MessageSquareText, Smartphone, ShieldCheck, Sparkles } from 'lucide-react';
export const ROUTES=[
  ...
  {section:'Operations',href:'/report-studio',label:'Report Studio',icon:FileText,badge:'New'},
  ...
  {section:'Network',href:'/campaigns',label:'Campaigns',icon:Mail,badge:'New'},
  {section:'Network',href:'/referrals',label:'Referrals',icon:GitBranch},
  {section:'Network',href:'/reviews',label:'Reviews / Locations',icon:Star},
];
export const FOOTER_ROUTES=[
  {href:'/quick-sms',label:'Quick SMS',icon:MessageSquareText},
  {href:'/fetch',label:'Document Intake',icon:Sparkles,badge:'AI'},
